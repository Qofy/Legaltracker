    ...
    <div class="max-w-7xl mx-auto mb-8">
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-gray-600 mt-2">
              Manage meetings, case deadlines, and appointments
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="bg-[green] rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-amber-100 text-sm">Total Events</p>
                <p class="text-2xl font-bold">23</p>
              </div>
              <Calendar class="w-8 h-8 text-amber-200" />
            </div>
          </div>
          <div
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-blue-100 text-sm">Meetings</p>
          ...
          <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-4 text-white">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-green-100 text-sm">Case Deadlines</p>
                <p class="text-2xl font-bold">9</p>
              </div>
              <Clock class="w-8 h-8 text-green-200" />
            </div>
          </div>
          <div
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
          ...
          <div
            v-if="casesWithoutDueDate.length === 0"
            ...
            >
              <div class="mb-2">
                ...
                <p class="text-xs text-gray-600">
                  Lawyer: {{ getAssignedLawyerName(caseItem) }}
                </p>
              </div>
            ...
            <div v-if="selectedEvent.data">
              ...
              <div class="bg-gray-50 rounded-lg p-3 text-sm">
                ...
                <div v-if="selectedEvent.type === 'meeting'">
                  <p v-if="selectedEvent.data.description" class="mb-2">
                    {{ selectedEvent.data.description }}
                  </p>
                  <p v-if="selectedEvent.data.location">
                    <strong>Location:</strong> {{ selectedEvent.data.location }}
                  </p>
                  <p v-if="selectedEvent.data.attendees">
                    <strong>Attendees:</strong> {{ selectedEvent.data.attendees.length }}
                  </p>
                  <p v-if="selectedEvent.data.case_info">
                    <strong>Case:</strong> {{ selectedEvent.data.case_info.title }}
                  </p>
                </div>
                ...
                <div v-if="selectedEvent.type === 'case'">
                  <p>
                    <strong>Case Number:</strong> {{ selectedEvent.data.case_number }}
                  </p>
                  <p v-if="selectedEvent.data.assigned_lawyer">
                    <strong>Lawyer:</strong>
                    {{ selectedEvent.data.assigned_lawyer.full_name }}
                  </p>
    ...
    >
      <div class="bg-white rounded-lg p-6 shadow-xl">
        <div class="flex items-center gap-3">
          <div
            class="animate-spin rounded-full h-6 w-6 border-b-2 border-[#003aca]"
          ></div>
...
// Reactive state
// Default to January 2026 as requested for admin view
...
const meetingEvents = computed(() => events.value.filter((e) => e.type === "meeting"));

const caseEvents = computed(() => events.value.filter((e) => e.type === "case"));
...
const assignDueDate = async (caseItem) => {
  ...
  try {
    ...
    showNotification(
      `✅ Due date set for "${caseItem.title}": ${format(
